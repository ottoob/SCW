...
<head>
    ...
    <%@include file="/WEB-INF/includes/cs-file.jsp"%>
    <link rel="stylesheet" href="${REALPATH}/css/carousel.css">S
    <style>
        h3 {
            font-weight:bold;
        }
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="container">
                <div class="navbar-header">
                    <a class="navbar-brand" href="${REALPATH}//index.jsp" style="font-size:32px;">尚筹网-创意产品众筹平台</a>
                </div>
                <div id="navbar" class="navbar-collapse collapse" style="float:right;">
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="${REALPATH}/login.jsp">登录</a></li>
                        <li><a href="${REALPATH}/reg.jsp">注册</a></li>
                    </ul>
                </div>
            </div>
        </nav>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <a class="left carousel-control" href="${REALPATH}/#myCarousel" role="button" data-slide="prev">
        <span class="glyphicon glyphicon-chevron-left"></span>
        <span class="sr-only">Previous</span>
    </a>
    <a class="right carousel-control" href="${REALPATH}/#myCarousel" role="button" data-slide="next">
...
<div class="container marketing">
    ...
    <div class="row">
        <div class="col-lg-4">
            ...
            <p><a class="btn btn-default" href="${REALPATH}/project.html" role="button">项目详情 &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
        ...
        <div class="row clearfix">
            <div class="col-md-12 column">
                <div class="box ui-draggable" id="mainBox">
                    <div class="mHd" style="">
                        <div class="path">
                            <a href="${REALPATH}/projects.html">更多...</a>
                        </div>
                        <h3>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        <h3 class="break">
                                            <a href="${REALPATH}/project.html">活性富氢净水直饮机</a>
                                        </h3>
                                        <p>
                            ...
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        <h3 class="break">
                                            <a href="${REALPATH}/project.html">酷驰触控龙头，智享厨房黑科技</a>
                                        </h3>
                                        <p>
                                        <div style="float:left;"><i class="glyphicon glyphicon-screenshot" title="目标金额" ></i> $20,000 </div>
                                        <div style="float:right;"><i title="截至日期" class="glyphicon glyphicon-calendar"></i> 2017-20-20 </div>
                            ...
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        <h3 class="break">
                                            <a href="${REALPATH}/project.html">小熊猫鱼眼全景安防摄像机</a>
                                        </h3>
                                        <p>
                                        <div style="float:left;"><i class="glyphicon glyphicon-screenshot" title="目标金额" ></i> $20,000 </div>
                                        <div style="float:right;"><i title="截至日期" class="glyphicon glyphicon-calendar"></i> 2017-20-20 </div>
                            ...
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        <h3 class="break">
                                            <a href="${REALPATH}/project.html">一款精致的机械表</a>
                                        </h3>
                                        <p>
                                        <div style="float:left;"><i class="glyphicon glyphicon-screenshot" title="目标金额" ></i> $20,000 </div>
                                        <div style="float:right;"><i title="截至日期" class="glyphicon glyphicon-calendar"></i> 2017-20-20 </div>
